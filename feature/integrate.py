...
# directory = '../../operons/data_mo'
# annotation_file_name = 'gene_annotation.bed'
# coverage_file_name = 'base_cov'
# label_file_name = 'mo_labels'
...
if __name__ == '__main__':
    ...
    # for each folder(organism) in directory
    for folder in organisms:
        if os.path.isdir(str(directory + '/' + folder)):
            annotation_path = directory + '/' + folder + '/' + annotation_file_name
            coverage_path = directory + '/' + folder + '/' + coverage_file_name
            label_path = directory + '/' + folder + '/' + label_file_name
            ...
            sequences = []
            reps = [filename.split("base_cov_")[1] for filename in os.listdir(directory + '/' + folder) if filename.startswith(coverage_file_name)]
